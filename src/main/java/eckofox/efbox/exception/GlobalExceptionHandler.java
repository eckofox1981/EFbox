...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> handleAccessCodeDoesNotExistsException(AccessCodeDoesNotExistsException exception) {
    ...
    public ResponseEntity<String> handleEmailNotSentException(EmailNotSentException exception) {
        EFBoxErrorMessage errMsg =
                messageCreator(
